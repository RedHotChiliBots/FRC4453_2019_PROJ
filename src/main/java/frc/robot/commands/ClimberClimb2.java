...
public class ClimberClimb2 extends CommandGroup {
  /**
   * Add your docs here.
   */
  public ClimberClimb2() {
    ...
    addSequential(new isSensor(Robot.climber.climbFrontDistanceSensor));
    ...
    addSequential(new isSensor(Robot.climber.climbBackDistanceSensor));
